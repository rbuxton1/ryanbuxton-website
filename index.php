<html>
  ...
  <body>
      ...
      <header class="w3-display-container" id="home">
        <img src="assets/mountains.jpg" alt="ryan" style="width:100%;">
      ...
      <div class='w3-container w3-margin'>
        ...
        <p class='w3-large w3-margin-left'>
          I am a college student at CU Denver studying computer science. So far I have studied Java and C++, and have I have taught myself PHP, HTML, basic MySQL, basic C. I will be learning lots of C++ in my college carrer. I also know a lot of Ubuntu tricks and am my high school's Cyber Patriot Ubuntu specialist. This site has been developed using these skills I have learned. All the code for this site can be found <a href='http://www.github.com/rbuxton1/ryanbuxton-website'>here</a>. I am also Amateur radio licensed with call sign KE0QIP. I dont talk much but you might see me sometime.
        </p>
      </div>
      <div class='w3-container w3-margin'>
        <h1 class='w3-xlarge'>ryan@ryan-desktop:~$ ryan -status </h1>
        <p class='w3-large w3-margin-left'>
          I am currently working on several projects, and they all can be veiwed <a href="http://www.github.com/rbuxton1">on my github</a>. The projects range from a Discord chat bot that I made for my personal Discord to the online registration system for NaMoPaiMo. I am also working on a rewrite of Show Helper, but I have chosen to not make that code public yet.
        </p>
      </div>
      <div class='w3-container w3-margin'>
        ...
        <div class='w3-row w3-border'>
          <div class="w3-third w3-container w3-red">
            <h1 class="w3-xxlarge">Show Helper</h1>
            <p class="w3-large">
          ...
          <div class="w3-third w3-container w3-green">
            <h1 class="w3-xxlarge">Student Art Archive (SAA)</h1>
            <p class="w3-large">
      ...
      <div class='w3-container w3-margin'>
        ...
        <p class='w3-large w3-margin-left'>
          The best way by far to contact me is over email at rbuxton1@gmail.com. I am always glad to hear out and idea or concept, but no promises on whether or not I will be able to do something or be willing. When in doubt, shoot me an email!
        </p>
      </div>
      ...
      <footer class="w3-container w3-theme-dark w3-padding-16">
        <p>
          <div class="w3-center">
            <p> <a href='http://www.github.com/rbuxton1'> << Ryan Buxton 2018 >> </a></p>
          </div>
        </p>
